package com.hackz.xyzreader.data;

import android.net.Uri;

class ItemsContract {
	static final String CONTENT_AUTHORITY = "com.hackz.xyzreader";
	private static final Uri BASE_URI = Uri.parse("content://com.hackz.xyzreader");
	...
	public static class Items implements ItemsColumns {
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.com.hackz.xyzreader.items";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.com.hackz.xyzreader.items";
